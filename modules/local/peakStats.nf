process PEAK_STATS {
    ...
    output:
    tuple val(meta_sample), val(meta_ploidy), val(meta_target), val(meta_ploidy_target), path("*_peak_data.tsv"), path("*_peak_stats.csv"), path("*_PeakIntegration.pdf"),	emit: peaks
	...
	touch ${meta_sample.sampleid}_${meta_ploidy.type}_${meta_target.name}_${meta_target.source}_peak_stats.csv
